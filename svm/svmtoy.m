...
plot(instance_matrix(pos, 1), instance_matrix(pos, 2), 'o', 'LineWidth', 3);
plot(instance_matrix(neg, 1), instance_matrix(neg, 2), 'rx', 'LineWidth', 3);
plot(svs(:,1), svs(:,2), 'y*', 'LineWidth', 2);

contour(bigX, bigY, bigZ, contour_level, 'LineWidth', 2);
